const CSS = [
  ...
  // Destructive action rendered as a quiet ghost (outline + tint) instead of a
  // heavy solid fill: in a row of many devices the solid red was loud. Hover
  // fills a soft red wash; the icon rides currentColor so hover recolors both.
