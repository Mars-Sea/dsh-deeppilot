...
| DSH CLI and Host API | `0.1.2-rc.1` minimum for plugin `0.6.x` | rc.1 package-family typecheck/build; bridge and `/phone` protocol tests |
...
- Plugin `0.6.x` requires DSH `0.1.2-rc.1` or newer. Older plugin
