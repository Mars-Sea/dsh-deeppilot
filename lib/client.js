window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		const TABLES = {
			zh: {
				...
				"connection.title": "连接",
				"connection.description": "控制手机可用的局域网与公网连接。",
				"connection.optionsSummary": "连接选项",
				"pair.description": "选择连接方式并生成一次性配对信息。",
				"devices.description": "管理已经配对的 iPhone。",
				"troubleshooting.summary": "测试与故障排查",
				"troubleshooting.title": "诊断工具",
				"troubleshooting.description": "仅在排查连接或推送问题时使用。",
				"system.summary": "系统信息",
				"system.title": "运行信息",
				"system.description": "插件、协议与连接端点的技术信息。",
				"local.title": "局域网连接",
				...
				"pair.qrExpired": "配对码已过期，请重新显示二维码",
				"pair.qrFailed": "二维码生成失败：",
				"pair.qrRetry": "重试",
				"pair.infoLabel": "配对信息（复制一次，粘贴到 App 即可）",
				"pair.infoCopyDone": "配对信息已复制",
				"pair.infoCopyFailed": "配对信息复制失败：",
				"pair.qrHint": "二维码与下面的「配对信息」内容相同：包含{kind}地址、一次性配对码、证书指纹（内网时）与主机标识。在局域网与公网之间切换会立即生成对应的新配对信息，配对码 5 分钟后失效。",
				...
				"devices.rename": "重命名",
				"devices.renameAria": "重命名设备“{name}”",
				"devices.nameLabel": "设备名称",
				"devices.namePlaceholder": "例如：工作手机",
				"devices.nameSave": "保存",
				"devices.nameCancel": "取消",
				"devices.nameSaving": "保存中…",
				"devices.nameInvalid": "设备名称不能超过 64 个字符。",
				"devices.customBadge": "自定义",
				"devices.unnamed": "未命名设备",
				"devices.renamed": "设备名称已保存",
				"devices.nameCleared": "已恢复设备默认名称",
				"devices.renameFailed": "设备名称保存失败：",
				"devices.renameStaleHost": "宿主插件版本较旧，不支持设备重命名 — 请更新 dsh-deeppilot",
				"devices.revoke": "删除",
				...
				"help.security4": "局域网连接使用插件独立的 3098 端口并启用 TLS。只在可信网络中使用，不要把该端口转发到公网。",
				...
				"diag.settingsUnavailable": "设置表单不可用（configForms 未提供）",
				...
				"diag.missingRename": "setDeviceName 回调缺失",
			...
			en: {
				...
				"connection.description": "Control the LAN and public connections available to your phone.",
				"connection.optionsSummary": "Connection options",
				"pair.description": "Choose a connection type and generate one-time pairing information.",
				"devices.description": "Manage iPhones that are already paired.",
				"troubleshooting.summary": "Tests and troubleshooting",
				"troubleshooting.title": "Diagnostic tools",
				"troubleshooting.description": "Use these only when diagnosing connection or push issues.",
				"system.summary": "System information",
				"system.title": "Runtime information",
				"system.description": "Technical details about the plugin, protocol, and endpoints.",
				...
				"pair.qrExpired": "Pairing code expired — show the QR code again",
				"pair.qrFailed": "QR generation failed: ",
				"pair.qrRetry": "Retry",
				"pair.infoLabel": "Pairing info (copy once, paste it in the app)",
				"pair.infoCopyDone": "Pairing info copied",
				"pair.infoCopyFailed": "Failed to copy pairing info: ",
				"pair.qrHint": "The QR code and the pairing info below carry the same {kind} address, single-use code, certificate fingerprint (for LAN) and host identity. Switching between LAN and public issues a matching new string immediately; the code expires after 5 minutes.",
				...
				"devices.renameAria": "Rename device “{name}”",
				"devices.nameLabel": "Device name",
				"devices.namePlaceholder": "For example: Work phone",
				"devices.nameSave": "Save",
				"devices.nameCancel": "Cancel",
				"devices.nameSaving": "Saving…",
				"devices.nameInvalid": "Device names cannot exceed 64 characters.",
				"devices.customBadge": "Custom",
				"devices.unnamed": "Unnamed device",
				"devices.renamed": "Device name saved",
				"devices.nameCleared": "Restored the device default name",
				"devices.renameFailed": "Failed to save device name: ",
				"devices.renameStaleHost": "The host plugin is too old to rename devices — please update dsh-deeppilot",
				...
				"help.security4": "LAN uses the plugin's independent port 3098 with TLS enabled. Use trusted networks only and never forward that port to the public Internet.",
				...
				"diag.summary": "Technical diagnostics",
				...
				"diag.settingsUnavailable": "Settings form unavailable (configForms not provided)",
				...
				"diag.missingRename": "setDeviceName callback missing",
		...
		*/
		...
		const LAN_TLS_FINGERPRINT_PATTERN = /^sha256:[A-Za-z0-9_-]{43}$/;
		function isLanTlsFingerprint(value) {
		...
		*/
		...
		function validTargetHost(value) {
			try {
				...
				return TARGET_PROTOCOLS.includes(parsed.protocol) && parsed.hostname !== "" && parsed.username === "" && parsed.password === "";
			} catch {
				return false;
			}
		}
		...
		*/
		function encodePairingLink(host, grant, tlsFingerprint) {
			assertPairingInput(host, grant, tlsFingerprint);
			const params = new URLSearchParams();
			params.set("h", host.trim());
			params.set("c", grant.code.trim());
			if (tlsFingerprint !== void 0) params.set("f", tlsFingerprint);
		...
		const PAIRING_LINK_PREFIX = "deeppilot://pair";
		function assertPairingInput(host, grant, tlsFingerprint) {
			if (!validTargetHost(host.trim())) throw new TypeError("pairing QR requires a valid HTTPS/WSS host");
			...
			if (tlsFingerprint !== void 0 && !isLanTlsFingerprint(tlsFingerprint)) throw new TypeError("pairing TLS fingerprint is invalid");
		}
		//#endregion
		//#region src/client/pairing-panel.ts
		const initialPairingPanelState = {
			target: null,
			busy: false,
			grant: null,
			link: null,
		...
		function pairingPanelReduce(state, action) {
			switch (action.type) {
				case "show": return {
				...
				case "dismissNotice": return state.notice === "" ? state : {
					...state,
					notice: ""
				};
				case "close": return {
		...
		function pairingPanelView(state) {
		...
		*  apart from React. */
		...
		const CheckIcon = () => (0, react.createElement)("svg", {
			className: "pbb-controlIcon",
			viewBox: "0 0 16 16",
			width: 14,
			height: 14,
			fill: "none",
			...
			strokeLinejoin: "round",
			"aria-hidden": true
		}, (0, react.createElement)("path", { d: "m3 8.3 3.1 3.1L13 4.8" }));
		const CloseIcon = () => (0, react.createElement)("svg", {
			className: "pbb-controlIcon",
			viewBox: "0 0 16 16",
			width: 14,
			height: 14,
			...
			strokeLinecap: "round",
			"aria-hidden": true
		}, (0, react.createElement)("path", { d: "m4.5 4.5 7 7m0-7-7 7" }));
		...
		*  label at render time via t(props.t, ...). */
		...
		function DeepPilotSettingsPage(props) {
			...
			const [pairingPanel, dispatchPairingPanel] = (0, react.useReducer)(pairingPanelReduce, initialPairingPanelState);
			const qrRequestId = (0, react.useRef)(0);
			const [troubleshootingOpen, setTroubleshootingOpen] = (0, react.useState)(false);
			...
			const [deviceBusyAction, setDeviceBusyAction] = (0, react.useState)(null);
			const [deviceMessage, setDeviceMessage] = (0, react.useState)("");
			const [editingDeviceId, setEditingDeviceId] = (0, react.useState)(null);
			const [deviceNameDraft, setDeviceNameDraft] = (0, react.useState)("");
			(0, react.useEffect)(() => {
			...
			(0, react.useEffect)(() => {
				...
				const timer = globalThis.setTimeout(() => {
					dispatchPairingPanel({
						type: "close",
						message: translateWith(props.t, "pair.qrExpired")
					});
				}, remaining);
				return () => globalThis.clearTimeout(timer);
			}, [pairingPanel.grant]);
			(0, react.useEffect)(() => {
				...
				const timer = globalThis.setTimeout(() => dispatchPairingPanel({ type: "dismissNotice" }), 2500);
				return () => globalThis.clearTimeout(timer);
			}, [pairingPanel.notice]);
			const diag = [];
			let report = null;
			...
			try {
				...
				if (typeof props.setDeviceName !== "function") diag.push(translateWith(props.t, "diag.missingRename"));
			...
			*/
			const showPairingQR = (target) => {
				...
				props.beginPairing().then(async (grant) => {
					...
					return {
						grant,
						link,
						svg: await import_browser.toString(link, {
							type: "svg",
					...
					dispatchPairingPanel({
						type: "failed",
						requestId,
						message: translateWith(props.t, "pair.qrFailed") + (error instanceof Error ? error.message : String(error))
					});
				});
			};
			const hidePairingQR = () => {
			...
			const copyPairingInfo = () => {
				...
				writeClipboard(props.t, link).then(() => {
					dispatchPairingPanel({
						type: "notice",
						message: translateWith(props.t, "pair.infoCopyDone")
					});
				}, (error) => {
					dispatchPairingPanel({
						type: "notice",
						message: translateWith(props.t, "pair.infoCopyFailed") + (error instanceof Error ? error.message : String(error))
					});
				});
			};
			const primaryRows = [];
			...
			if (report !== null) {
				primaryRows.push((0, react.createElement)("div", {
					className: "pbb-stat",
					key: "conn"
				}, (0, react.createElement)("span", { className: "pbb-statLabel" }, translateWith(props.t, "panel.activeConnections")), (0, react.createElement)("span", { className: "pbb-statValue" }, String(report.activeConnections))), (0, react.createElement)("div", {
					className: "pbb-stat",
					key: "identity"
				}, (0, react.createElement)("span", { className: "pbb-statLabel" }, translateWith(props.t, "panel.identity")), (0, react.createElement)("code", { className: "pbb-token " + (report.pairingReady ? "pbb-ok" : "pbb-bad") }, report.pairingReady ? translateWith(props.t, "panel.identityReady") : translateWith(props.t, "panel.identityNotReady"))));
				if (report.local.phase === "online" && report.local.tlsFingerprint) advancedRows.push((0, react.createElement)("div", {
					className: "pbb-runtimeRow",
					key: "tls"
				}, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, translateWith(props.t, "local.tlsFingerprint")), (0, react.createElement)("code", { className: "pbb-token" }, report.local.tlsFingerprint))));
			...
			const deviceLabel = (device) => (device.customName ?? device.deviceName).trim() || translateWith(props.t, "devices.unnamed");
			const beginDeviceRename = (device) => {
			...
			const saveDeviceName = (deviceId) => {
				...
				if (normalized.length > 64) {
					setDeviceMessage(translateWith(props.t, "devices.nameInvalid"));
					return;
				}
				setDeviceBusy(deviceId);
				setDeviceBusyAction("rename");
				setDeviceMessage("");
				props.setDeviceName(deviceId, normalized === "" ? null : normalized).then(() => {
					setDeviceMessage(normalized === "" ? translateWith(props.t, "devices.nameCleared") : translateWith(props.t, "devices.renamed"));
					setEditingDeviceId(null);
					setDeviceNameDraft("");
				}, (error) => {
					setDeviceMessage(translateWith(props.t, "devices.renameFailed") + (error instanceof Error ? error.message : String(error)));
				}).finally(() => {
					setDeviceBusy(null);
					setDeviceBusyAction(null);
				});
			...
			const deviceTable = visibleDevices.length > 0 ? (0, react.createElement)("div", { className: "pbb-tableWrap" }, (0, react.createElement)("table", { className: "pbb-table" }, (0, react.createElement)("thead", null, (0, react.createElement)("tr", null, (0, react.createElement)("th", null, translateWith(props.t, "devices.col.name")), (0, react.createElement)("th", null, translateWith(props.t, "devices.col.lastSeen")), (0, react.createElement)("th", { className: "pbb-tableActionHead" }, translateWith(props.t, "devices.col.actions")))), (0, react.createElement)("tbody", null, visibleDevices.map((d) => {
				...
				return (0, react.createElement)("tr", {
					key: d.deviceId,
					"aria-busy": busy
				}, (0, react.createElement)("td", null, editing ? (0, react.createElement)("form", {
					className: "pbb-deviceRenameForm",
					onSubmit: (event) => {
						event.preventDefault();
						saveDeviceName(d.deviceId);
					}
				}, (0, react.createElement)("div", { className: "pbb-deviceRenameControls" }, (0, react.createElement)("input", {
					...
					autoFocus: true,
					disabled: busy,
					placeholder: translateWith(props.t, "devices.namePlaceholder"),
					"aria-label": translateWith(props.t, "devices.nameLabel"),
				...
				}), (0, react.createElement)("div", { className: "pbb-deviceRenameActions" }, (0, react.createElement)("button", {
					type: "submit",
					className: "pbb-action pbb-deviceIconAction pbb-buttonPrimary",
					disabled: busy || deviceNameDraft.length > 64,
					title: busy ? translateWith(props.t, "devices.nameSaving") : translateWith(props.t, "devices.nameSave"),
					"aria-label": busy ? translateWith(props.t, "devices.nameSaving") : translateWith(props.t, "devices.nameSave")
				}, busy ? (0, react.createElement)("span", {
					className: "pbb-inlineSpinner",
					"aria-hidden": true
				}) : CheckIcon()), (0, react.createElement)("button", {
					type: "button",
					className: "pbb-action pbb-deviceIconAction",
					disabled: busy,
					title: translateWith(props.t, "devices.nameCancel"),
					"aria-label": translateWith(props.t, "devices.nameCancel"),
					onClick: cancelDeviceRename
				}, CloseIcon()))), deviceNameDraft.length > 64 ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, translateWith(props.t, "devices.nameInvalid")) : null) : (0, react.createElement)("div", null, (0, react.createElement)("div", { className: "pbb-deviceNameRow" }, (0, react.createElement)("span", { className: "pbb-deviceName" }, label), d.customName ? (0, react.createElement)("span", { className: "pbb-badge" }, translateWith(props.t, "devices.customBadge")) : null), (0, react.createElement)("span", { className: "pbb-deviceMeta" }, d.appVersion, " · ", (0, react.createElement)("code", null, d.fingerprint.slice(0, 12))))), (0, react.createElement)("td", { className: "pbb-lastSeen" }, new Date(d.lastSeenTs).toLocaleString()), (0, react.createElement)("td", { className: "pbb-tableActionCell" }, !editing ? (0, react.createElement)("button", {
					type: "button",
					className: "pbb-action",
					disabled: busy || editingDeviceId !== null || typeof props.setDeviceName !== "function",
					"aria-label": translateWith(props.t, "devices.renameAria", { name: label }),
					onClick: () => beginDeviceRename(d)
				}, translateWith(props.t, "devices.rename")) : null, (0, react.createElement)("button", {
					type: "button",
					className: "pbb-action pbb-actionDangerGhost",
					disabled: busy,
					"aria-label": busy && deviceBusyAction === "revoke" ? translateWith(props.t, "devices.deleting", { name: label }) : translateWith(props.t, "devices.revokeAria", { name: label }),
					onClick: () => revokeDevice(d.deviceId, label)
				}, busy && deviceBusyAction === "revoke" ? null : TrashIcon(), busy && deviceBusyAction === "revoke" ? (0, react.createElement)("span", { className: "pbb-actionBusy" }, translateWith(props.t, "devices.deleting")) : translateWith(props.t, "devices.revoke"))));
			...
			const connectionNeedsAttention = localMeta?.dot.includes("pbb-dotBad") === true || remoteMeta?.dot.includes("pbb-dotBad") === true;
			const connectionOnline = localMeta?.dot.includes("pbb-dotOk") === true || remoteMeta?.dot.includes("pbb-dotOk") === true;
			const serviceStatus = !switchReady ? translateWith(props.t, "status.loading") : !enabled ? translateWith(props.t, "status.off") : connectionNeedsAttention ? translateWith(props.t, "status.attention") : connectionOnline ? translateWith(props.t, "status.ready") : translateWith(props.t, "status.loading");
			const serviceDot = !enabled ? "" : connectionNeedsAttention ? " pbb-dotBad" : connectionOnline ? " pbb-dotOk" : " pbb-dotWarn";
			const renderConnectionTile = (key, title, description, checked, ready, dot, statusLabel, onToggle, extra = null) => (0, react.createElement)("div", {
				className: "pbb-connectionTile",
				key
			}, (0, react.createElement)("div", { className: "pbb-connectionTileHeader" }, (0, react.createElement)("span", { className: "pbb-switchTitle pbb-dotRow" }, (0, react.createElement)("span", {
				...
				onClick: onToggle
			})), (0, react.createElement)("span", { className: "pbb-connectionState" }, statusLabel), (0, react.createElement)("p", { className: "pbb-connectionDescription" }, description), extra);
			return (0, react.createElement)("div", { className: "pbb-section" }, (0, react.createElement)("header", { className: "pbb-pageHeader" }, (0, react.createElement)("div", null, (0, react.createElement)("h2", { className: "pbb-title" }, "DeepPilot"), (0, react.createElement)("p", { className: "pbb-intro" }, translateWith(props.t, "meta.intro"))), (0, react.createElement)("button", {
				type: "button",
				className: "pbb-refresh",
				onClick: () => {
					if (typeof props.refresh === "function") props.refresh();
				}
			}, translateWith(props.t, "meta.refresh"))), (0, react.createElement)("div", { className: "pbb-card pbb-primaryCard" }, (0, react.createElement)("div", { className: "pbb-cardHeader" }, (0, react.createElement)("div", null, (0, react.createElement)("h3", { className: "pbb-cardTitle" }, translateWith(props.t, "connection.title")), (0, react.createElement)("p", { className: "pbb-cardDescription" }, translateWith(props.t, "connection.description"))), (0, react.createElement)("span", { className: "pbb-statusBadge" }, (0, react.createElement)("span", { className: "pbb-dot" + serviceDot }), serviceStatus)), (0, react.createElement)("div", { className: "pbb-masterRow" }, (0, react.createElement)("div", { className: "pbb-switchText" }, (0, react.createElement)("span", { className: "pbb-switchTitle" }, switchTitle), (0, react.createElement)("span", { className: "pbb-switchDesc" }, switchDesc)), (0, react.createElement)("button", {
				type: "button",
				role: "switch",
			...
			})), (0, react.createElement)("div", { className: "pbb-connectionGrid" }, renderConnectionTile("local", translateWith(props.t, "local.title"), localSwitchReady ? localEnabled ? translateWith(props.t, "local.on", { port: localPort }) : translateWith(props.t, "local.off") : translateWith(props.t, "master.loading"), localEnabled, localSwitchReady, localMeta?.dot ?? "", localMeta === null ? translateWith(props.t, "phase.unknown") : translateWith(props.t, localMeta.labelKey), () => {
				if (typeof props.setDeepPilotLocalEnabled === "function") props.setDeepPilotLocalEnabled(!localEnabled);
			}, (0, react.createElement)(react.Fragment, null, report !== null && report.local.message && report.local.phase === "error" ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, report.local.message) : null, report !== null && report.local.tlsIdentityRegenerated === true ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, translateWith(props.t, "local.tlsRegenerated")) : null)), renderConnectionTile("remote", translateWith(props.t, "remote.title"), remoteSwitchReady ? remoteEnabled ? translateWith(props.t, "remote.on") : translateWith(props.t, "remote.off") : translateWith(props.t, "master.loading"), remoteEnabled, remoteSwitchReady, remoteMeta?.dot ?? "", remoteMeta === null ? translateWith(props.t, "phase.unknown") : translateWith(props.t, remoteMeta.labelKey), () => {
				if (typeof props.setDeepPilotRemoteEnabled === "function") props.setDeepPilotRemoteEnabled(!remoteEnabled);
			}, (0, react.createElement)(react.Fragment, null, report !== null && report.remote.phase === "login_required" && typeof report.remote.authURL === "string" && report.remote.authURL.startsWith("https://") ? (0, react.createElement)("div", { className: "pbb-rowAction" }, (0, react.createElement)("a", {
				className: "pbb-action pbb-buttonPrimary",
				href: report.remote.authURL,
				target: "_blank",
				rel: "noreferrer"
			}, translateWith(props.t, "remote.openAuth"))) : null, report !== null && report.remote.message && (report.remote.phase === "error" || report.remote.phase === "unavailable") ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, report.remote.message) : null))), report === null ? null : (0, react.createElement)("div", { className: "pbb-statGrid" }, primaryRows), (0, react.createElement)("details", { className: "pbb-inlineDetails" }, (0, react.createElement)("summary", null, translateWith(props.t, "connection.optionsSummary")), (0, react.createElement)("div", { className: "pbb-helpBody" }, (0, react.createElement)("div", { className: "pbb-limitRow pbb-limitNested" }, (0, react.createElement)("div", { className: "pbb-switchText" }, (0, react.createElement)("label", {
				...
				target: "_blank",
				rel: "noreferrer"
			}, translateWith(props.t, "help.funnelDocs"))))))), report === null ? null : (0, react.createElement)("div", { className: "pbb-card" }, (0, react.createElement)("div", { className: "pbb-cardHeader" }, (0, react.createElement)("div", null, (0, react.createElement)("h3", { className: "pbb-cardTitle" }, translateWith(props.t, "pair.qrPanelTitle")), (0, react.createElement)("p", { className: "pbb-cardDescription" }, translateWith(props.t, "pair.description"))), pairingTarget === null ? (0, react.createElement)("span", { className: "pbb-statusBadge pbb-bad" }, translateWith(props.t, "pair.noAddress")) : (0, react.createElement)("button", {
				type: "button",
				className: "pbb-action pbb-buttonPrimary",
			...
			}, translateWith(props.t, panel.action))), (0, react.createElement)("div", { className: "pbb-pairingBody" }, pairingTarget === null ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, translateWith(props.t, "pair.noAddressHelp")) : null, pairingTargets.length < 2 ? null : (0, react.createElement)("div", { className: "pbb-targetList" }, pairingTargets.map((target) => (0, react.createElement)("button", {
				type: "button",
				key: target.host,
			...
			}, (target.kind === "public" ? translateWith(props.t, "pair.kind.public") : translateWith(props.t, "pair.kind.lan")) + " · " + target.host))), panel.message ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, panel.message) : null, panel.notice ? (0, react.createElement)("p", { className: "pbb-diag" }, panel.notice) : null, panel.failed && pairingTarget !== null ? (0, react.createElement)("div", { className: "pbb-rowAction" }, (0, react.createElement)("button", {
				type: "button",
				className: "pbb-action",
				disabled: panel.busy || !report.pairingReady,
				onClick: () => showPairingQR(pairingTarget)
			}, translateWith(props.t, "pair.qrRetry"))) : null, panel.open ? (0, react.createElement)("div", { className: "pbb-qrPanel" }, panel.qrDataURL === null ? (0, react.createElement)("p", { className: "pbb-diag" }, translateWith(props.t, "pair.qrGenerating")) : (0, react.createElement)("img", {
				className: "pbb-qrImage",
				src: panel.qrDataURL,
				alt: translateWith(props.t, "pair.qrAlt")
			}), panel.link === null ? null : (0, react.createElement)("div", { className: "pbb-pairCodeBlock" }, (0, react.createElement)("span", { className: "pbb-pairCodeLabel" }, translateWith(props.t, "pair.infoLabel")), (0, react.createElement)("div", { className: "pbb-pairCodeRow" }, (0, react.createElement)("code", { className: "pbb-pairCode" }, panel.link), (0, react.createElement)("button", {
				type: "button",
				className: "pbb-action pbb-buttonPrimary",
				onClick: copyPairingInfo,
				"data-testid": "pairingInfoCopy"
			}, translateWith(props.t, "panel.tokenAction.copy")))), (0, react.createElement)("p", { className: "pbb-qrHint" }, translateWith(props.t, "pair.qrHint", { kind: panel.target?.kind === "public" ? translateWith(props.t, "pair.kind.public") : translateWith(props.t, "pair.kind.lan") }))) : null)), (0, react.createElement)("div", { className: "pbb-card" }, (0, react.createElement)("div", { className: "pbb-cardHeader" }, (0, react.createElement)("div", null, (0, react.createElement)("h3", { className: "pbb-cardTitle" }, translateWith(props.t, "devices.title")), (0, react.createElement)("p", { className: "pbb-cardDescription" }, translateWith(props.t, "devices.description"))), (0, react.createElement)("span", { className: "pbb-countBadge" }, String(visibleDevices.length))), (0, react.createElement)("div", { className: "pbb-cardBody" }, deviceMessage ? (0, react.createElement)("p", { className: "pbb-diag" + (deviceMessage.startsWith(translateWith(props.t, "devices.renameFailed")) || deviceMessage.startsWith(translateWith(props.t, "devices.revokeFailed")) ? " pbb-diagBad" : "") }, deviceMessage) : null, deviceTable)), (0, react.createElement)("details", {
				className: "pbb-card pbb-disclosure",
				open: troubleshootingOpen,
				onToggle: (event) => setTroubleshootingOpen(event.currentTarget.open)
			}, (0, react.createElement)("summary", null, (0, react.createElement)("span", { className: "pbb-disclosureTitle" }, translateWith(props.t, "troubleshooting.summary")), (0, react.createElement)("span", { className: "pbb-disclosureMeta" }, relayTestResult !== null ? relayTestResult.overall === "ok" ? translateWith(props.t, "push.relayOk") : translateWith(props.t, "push.relayBad") : pushTestResult !== null ? pushTestResult.overall === "sent" ? translateWith(props.t, "push.pushSent") : translateWith(props.t, "push.pushFailed") : translateWith(props.t, "troubleshooting.title"))), (0, react.createElement)("div", { className: "pbb-disclosureBody" }, (0, react.createElement)("div", { className: "pbb-sectionIntro" }, (0, react.createElement)("h3", { className: "pbb-cardTitle" }, translateWith(props.t, "troubleshooting.title")), (0, react.createElement)("p", { className: "pbb-cardDescription" }, translateWith(props.t, "troubleshooting.description"))), (0, react.createElement)("div", { className: "pbb-testGrid" }, (0, react.createElement)("div", { className: "pbb-testItem" }, (0, react.createElement)("div", { className: "pbb-switchText" }, (0, react.createElement)("span", { className: "pbb-testTitle" }, translateWith(props.t, "push.relayTitle")), (0, react.createElement)("span", { className: "pbb-testDescription" }, translateWith(props.t, "push.relayDefault"))), (0, react.createElement)("button", {
				type: "button",
				className: "pbb-action",
				disabled: relayTestBusy,
				onClick: runRelayTest
			}, relayTestBusy ? translateWith(props.t, "push.relayTesting") : translateWith(props.t, "push.testRelay"))), (0, react.createElement)("div", { className: "pbb-testItem" }, (0, react.createElement)("div", { className: "pbb-switchText" }, (0, react.createElement)("span", { className: "pbb-testTitle" }, translateWith(props.t, "push.testPush")), (0, react.createElement)("span", { className: "pbb-testDescription" }, translateWith(props.t, "push.pushDefault"))), (0, react.createElement)("button", {
				type: "button",
				className: "pbb-action",
				...
				className: "pbb-diag",
				key: String(index)
			}, (r.outcome === "sent" ? "✓ " : "✗ ") + r.name + " [" + r.environment + "] — " + r.outcome + (r.reason ? "（" + r.reason + "）" : "") + (r.tokenFingerprint ? "　token:" + r.tokenFingerprint + "…" : "")))))), report === null ? null : (0, react.createElement)("details", { className: "pbb-card pbb-disclosure" }, (0, react.createElement)("summary", null, (0, react.createElement)("span", { className: "pbb-disclosureTitle" }, translateWith(props.t, "system.summary")), (0, react.createElement)("span", { className: "pbb-disclosureMeta" }, "v" + report.pluginVersion)), (0, react.createElement)("div", { className: "pbb-disclosureBody" }, (0, react.createElement)("div", { className: "pbb-sectionIntro" }, (0, react.createElement)("h3", { className: "pbb-cardTitle" }, translateWith(props.t, "system.title")), (0, react.createElement)("p", { className: "pbb-cardDescription" }, translateWith(props.t, "system.description"))), (0, react.createElement)("div", { className: "pbb-runtimeList" }, (0, react.createElement)("div", { className: "pbb-runtimeRow" }, (0, react.createElement)("span", { className: "pbb-label" }, "DeepPilot"), (0, react.createElement)("span", { className: "pbb-value" }, "v" + report.pluginVersion)), advancedRows, report.updateAvailable === true ? (0, react.createElement)("div", { className: "pbb-updateRow" }, (0, react.createElement)("span", null, translateWith(props.t, "update.badge")), (0, react.createElement)("a", {
				className: "pbb-action pbb-buttonPrimary",
				...
				target: "_blank",
				rel: "noreferrer"
			}, translateWith(props.t, "update.badge"))) : null))), diag.length > 0 ? (0, react.createElement)("details", {
				className: "pbb-card pbb-disclosure pbb-diagnostics",
				open: failed
			}, (0, react.createElement)("summary", null, translateWith(props.t, "diag.summary")), (0, react.createElement)("div", { className: "pbb-disclosureBody" }, (0, react.createElement)("p", { className: "pbb-diag" + (failed ? " pbb-diagBad" : "") }, translateWith(props.t, "diag.prefix") + diag.join(" | ")))) : null);
		}
		//#endregion
		...
		*/
		function plainSection(value) {
			if (value === null || typeof value !== "object") return value;
			if (typeof value.get === "function") return plainSection(value.get());
			const plain = {};
			for (const [key, item] of Object.entries(value)) plain[key] = item !== null && typeof item === "object" ? plainSection(item) : item;
			return plain;
		}
		/**
		...
		*/
		function adaptConfigForm(forms, entryId) {
			const form = forms?.get?.(entryId);
			if (form === void 0) return void 0;
			const accept = async (pending) => {
		...
		*/
		function bindConfigForm(ctx) {
			return adaptConfigForm(ctx.get("configForms"), "deeppilot");
		}
		//#endregion
		...
		*/
		...
		function apply(ctx) {
			...
			const setDeviceName = async (deviceId, customName) => {
				if (namespace === void 0) throw new Error(mountError !== void 0 ? t(ctx, "diag.mountFailedShort") + mountError : t(ctx, "diag.remoteUnmounted"));
				if (typeof namespace.setDeviceName !== "function") throw new Error(t(ctx, "devices.renameStaleHost"));
