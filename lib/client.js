	...
	factory: (require) => {
		...
		*  construction, is one we did not register for). */
		function detectLocale(ctx) {
			...
			if (bind === void 0) return "en";
			try {
				if (bind("nav") === TABLES.zh["nav"]) return "zh";
			} catch {
				return "en";
			}
			return "en";
		...
		*  "second wins", which is the same thing. */
		function registerLocale(ctx) {
			ctx.locale?.register(DEEPPILOT_LOCALE_NS, {
				zh: TABLES.zh,
				en: TABLES.en
			});
		}
		...
		*  label at render time via t(props.t, ...). */
		...
		function DeepPilotSettingsPage(props) {
			...
			try {
				...
				} else diag.push(t(props.t, "diag.missingEnabledHook"));
				...
				} else diag.push(t(props.t, "diag.missingRemoteEnabledHook"));
			...
			const copyToken = () => {
				...
				setTokenBusy(true);
				setTokenMessage("");
				(revealedToken !== null ? Promise.resolve(revealedToken) : props.revealPairingToken()).then((value) => writeClipboard(props.t, value)).then(() => setTokenMessage(t(props.t, "panel.tokenCopied")), (error) => {
			...
			if (report !== null) {
				primaryRows.push((0, react.createElement)("div", {
					className: "pbb-field",
					key: "conn"
				}, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, t(props.t, "panel.activeConnections")), (0, react.createElement)("span", { className: "pbb-value" }, String(report.activeConnections)))), (0, react.createElement)("div", {
					className: "pbb-field",
					key: "token"
				}, (0, react.createElement)("div", { className: "pbb-row pbb-tokenRow" }, (0, react.createElement)("span", { className: "pbb-label" }, t(props.t, "panel.token")), (0, react.createElement)("code", { className: "pbb-token " + (report.tokenReady ? "pbb-ok" : "pbb-bad") }, report.tokenReady ? revealedToken ?? "••••••••••••" : t(props.t, "panel.tokenNotReady")), report.tokenReady ? (0, react.createElement)("span", { className: "pbb-tokenActions" }, (0, react.createElement)("button", {
					type: "button",
					className: "pbb-action",
					disabled: tokenBusy,
					onClick: toggleToken
				}, tokenBusy ? t(props.t, "panel.tokenAction.showing") : revealedToken === null ? t(props.t, "panel.tokenAction.show") : t(props.t, "panel.tokenAction.hide")), (0, react.createElement)("button", {
					type: "button",
					className: "pbb-action",
					disabled: tokenBusy,
					onClick: copyToken
				}, t(props.t, "panel.tokenAction.copy")), (0, react.createElement)("button", {
					type: "button",
					className: "pbb-action" + (rotateArmed ? " pbb-actionDanger" : ""),
					disabled: tokenBusy,
					onClick: rotateToken
				}, rotateArmed ? t(props.t, "panel.tokenAction.rotateConfirm") : tokenBusy ? t(props.t, "panel.tokenAction.rotating") : t(props.t, "panel.tokenAction.rotate"))) : null), tokenMessage ? (0, react.createElement)("p", { className: "pbb-diag" }, tokenMessage) : null));
				advancedRows.push((0, react.createElement)("div", {
					className: "pbb-field",
					key: "proto"
				}, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, t(props.t, "advanced.protocolVersion")), (0, react.createElement)("span", { className: "pbb-value" }, "v" + String(report.protocolVersion)))), (0, react.createElement)("div", {
					className: "pbb-field",
					key: "server"
				}, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, t(props.t, "advanced.serverVersion")), (0, react.createElement)("span", { className: "pbb-value" }, report.serverVersion))), (0, react.createElement)("div", {
					className: "pbb-field",
					key: "path"
				}, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, t(props.t, "advanced.tokenPath")), (0, react.createElement)("span", { className: "pbb-value" }, report.tokenPath))), (0, react.createElement)("div", {
					className: "pbb-field",
					key: "buffer"
				}, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, t(props.t, "advanced.bufferMax")), (0, react.createElement)("span", { className: "pbb-value" }, String(report.historyBufferMax) + t(props.t, "advanced.frames")))));
			}
			const deviceTable = report !== null && report.devices.length > 0 ? (0, react.createElement)("table", { className: "pbb-table" }, (0, react.createElement)("thead", null, (0, react.createElement)("tr", null, (0, react.createElement)("th", null, t(props.t, "devices.col.name")), (0, react.createElement)("th", null, t(props.t, "devices.col.appVersion")), (0, react.createElement)("th", null, t(props.t, "devices.col.push")), (0, react.createElement)("th", null, t(props.t, "devices.col.lastSeen")))), (0, react.createElement)("tbody", null, report.devices.map((d) => (0, react.createElement)("tr", { key: d.deviceId }, (0, react.createElement)("td", null, d.deviceName), (0, react.createElement)("td", null, d.appVersion), (0, react.createElement)("td", null, d.apns ? t(props.t, "devices.pushRegistered") + (d.apns.environment === "production" ? t(props.t, "devices.pushEnvProduction") : t(props.t, "devices.pushEnvDevelopment")) + "）" : t(props.t, "devices.pushNotRegistered")), (0, react.createElement)("td", null, new Date(d.lastSeenTs).toLocaleString()))))) : (0, react.createElement)("p", { className: "pbb-empty" }, t(props.t, "devices.empty"));
			const switchTitle = t(props.t, "master.title");
			const switchDesc = switchReady ? enabled ? t(props.t, "master.on") : t(props.t, "master.off") : t(props.t, "master.loading");
			return (0, react.createElement)("div", { className: "pbb-section" }, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("h2", { className: "pbb-title" }, "DeepPilot"), (0, react.createElement)("div", { style: { flex: "1" } }), (0, react.createElement)("button", {
			...
			}, t(props.t, "meta.refresh"))), (0, react.createElement)("p", { className: "pbb-intro" }, t(props.t, "meta.intro")), (0, react.createElement)("div", { className: "pbb-card" }, (0, react.createElement)("div", { className: "pbb-switchRow" }, (0, react.createElement)("div", { className: "pbb-switchText" }, (0, react.createElement)("span", { className: "pbb-switchTitle" }, switchTitle), (0, react.createElement)("span", { className: "pbb-switchDesc" }, switchDesc)), (0, react.createElement)("button", {
				type: "button",
				role: "switch",
				...
				title: report !== null ? t(props.t, REMOTE_PHASE_META[report.remote.phase].labelKey) : void 0
			}), t(props.t, "remote.title")), (0, react.createElement)("span", { className: "pbb-switchDesc" }, remoteSwitchReady ? remoteEnabled ? t(props.t, "remote.on") : t(props.t, "remote.off") : t(props.t, "master.loading")), report !== null && report.remote.phase === "login_required" && typeof report.remote.authURL === "string" && report.remote.authURL.startsWith("https://") ? (0, react.createElement)("div", { className: "pbb-rowAction" }, (0, react.createElement)("a", {
				className: "pbb-action",
				href: report.remote.authURL,
				target: "_blank",
				rel: "noreferrer"
			}, t(props.t, "remote.openAuth"))) : null, report !== null && report.remote.message && (report.remote.phase === "error" || report.remote.phase === "unavailable") ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, report.remote.message) : null, remoteMessage ? (0, react.createElement)("p", { className: "pbb-diag" }, remoteMessage) : null), (0, react.createElement)("button", {
				type: "button",
				role: "switch",
			...
			})), (0, react.createElement)("details", { className: "pbb-help" }, (0, react.createElement)("summary", null, t(props.t, "help.remoteTitle")), (0, react.createElement)("div", { className: "pbb-helpBody" }, (0, react.createElement)("div", { className: "pbb-helpSection" }, (0, react.createElement)("div", { className: "pbb-helpHeading" }, t(props.t, "help.recommended")), (0, react.createElement)("ol", { className: "pbb-helpList" }, (0, react.createElement)("li", null, t(props.t, "help.step1")), (0, react.createElement)("li", null, t(props.t, "help.step2")), (0, react.createElement)("li", null, t(props.t, "help.step3")), (0, react.createElement)("li", null, t(props.t, "help.step4"))), (0, react.createElement)("p", { className: "pbb-helpText" }, t(props.t, "help.funnelHint"))), (0, react.createElement)("div", { className: "pbb-helpSection" }, (0, react.createElement)("div", { className: "pbb-helpHeading" }, t(props.t, "help.httpsTitle")), (0, react.createElement)("ol", { className: "pbb-helpList" }, (0, react.createElement)("li", null, t(props.t, "help.httpsStep1")), (0, react.createElement)("li", null, t(props.t, "help.httpsStep2")), (0, react.createElement)("li", null, t(props.t, "help.httpsStep3"))), (0, react.createElement)("p", { className: "pbb-helpText" }, t(props.t, "help.httpsHint"))), (0, react.createElement)("div", { className: "pbb-helpSection" }, (0, react.createElement)("div", { className: "pbb-helpHeading" }, t(props.t, "help.allowTitle")), (0, react.createElement)("p", { className: "pbb-helpText" }, t(props.t, "help.allowBody")), (0, react.createElement)("code", { className: "pbb-helpCode" }, "\"nodeAttrs\": [\n  {\n    \"target\": [\"autogroup:member\"],\n    \"attr\": [\"funnel\"],\n  },\n],"), (0, react.createElement)("p", { className: "pbb-helpText" }, t(props.t, "help.allowHint"))), (0, react.createElement)("div", { className: "pbb-helpSection" }, (0, react.createElement)("div", { className: "pbb-helpHeading" }, t(props.t, "help.faqTitle")), (0, react.createElement)("ul", { className: "pbb-helpList" }, (0, react.createElement)("li", null, t(props.t, "help.faq1")), (0, react.createElement)("li", null, t(props.t, "help.faq2")), (0, react.createElement)("li", null, t(props.t, "help.faq3")), (0, react.createElement)("li", null, t(props.t, "help.faq4")))), (0, react.createElement)("div", { className: "pbb-helpSection" }, (0, react.createElement)("div", { className: "pbb-helpHeading" }, t(props.t, "help.securityTitle")), (0, react.createElement)("ul", { className: "pbb-helpList" }, (0, react.createElement)("li", null, t(props.t, "help.security1")), (0, react.createElement)("li", null, t(props.t, "help.security2")), (0, react.createElement)("li", null, t(props.t, "help.security3")), (0, react.createElement)("li", null, t(props.t, "help.security4")), (0, react.createElement)("li", null, t(props.t, "help.security5"))), (0, react.createElement)("p", { className: "pbb-helpText" }, t(props.t, "help.docsPrefix"), (0, react.createElement)("a", {
				className: "pbb-helpLink",
				href: "https://tailscale.com/docs/features/tailscale-funnel",
				target: "_blank",
				rel: "noreferrer"
			}, t(props.t, "help.funnelDocs"))))))), report === null ? null : (0, react.createElement)("div", { className: "pbb-card" }, (0, react.createElement)("div", { className: "pbb-field" }, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, t(props.t, "pair.qrPanelTitle")), pairingTarget === null ? (0, react.createElement)("span", { className: "pbb-value pbb-bad" }, t(props.t, "pair.noAddress")) : (0, react.createElement)("span", { className: "pbb-tokenActions" }, (0, react.createElement)("span", { className: "pbb-badge" }, pairingTarget.kind === "public" ? t(props.t, "pair.kind.public") : t(props.t, "pair.kind.lan")), (0, react.createElement)("button", {
				type: "button",
				className: "pbb-action",
			...
			}, qrBusy ? t(props.t, "pair.qrGenerating") : qrDataURL === null ? t(props.t, "pair.qrShow") : t(props.t, "pair.qrHide")))), pairingTarget === null ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, t(props.t, "pair.noAddressHelp")) : null, qrMessage ? (0, react.createElement)("p", { className: "pbb-diag" }, qrMessage) : null, pairingTarget === null || qrDataURL === null ? null : (0, react.createElement)("div", { className: "pbb-qrPanel" }, (0, react.createElement)("img", {
			...
			}, t(props.t, "panel.tokenAction.copy"))), (0, react.createElement)("p", { className: "pbb-qrHint" }, t(props.t, "pair.qrHint", { kind: pairingTarget.kind === "public" ? t(props.t, "pair.kind.public") : t(props.t, "pair.kind.lan") }))))), (0, react.createElement)("div", { className: "pbb-card" }, (0, react.createElement)("div", { className: "pbb-field" }, primaryRows, advancedRows.length > 0 ? (0, react.createElement)("details", { className: "pbb-help" }, (0, react.createElement)("summary", null, t(props.t, "advanced.summary")), (0, react.createElement)("div", { className: "pbb-helpBody" }, advancedRows)) : null)), (0, react.createElement)("div", { className: "pbb-card" }, (0, react.createElement)("div", { className: "pbb-field" }, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, t(props.t, "push.relayTitle")), (0, react.createElement)("span", { className: "pbb-tokenActions" }, (0, react.createElement)("button", {
				type: "button",
				className: "pbb-action",
				disabled: relayTestBusy,
				onClick: runRelayTest
			}, relayTestBusy ? t(props.t, "push.relayTesting") : t(props.t, "push.testRelay")), (0, react.createElement)("button", {
				type: "button",
				className: "pbb-action",
				disabled: pushTestBusy,
				onClick: sendPushTest
			}, pushTestBusy ? t(props.t, "push.pushSending") : t(props.t, "push.testPush")))), relayTestError ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, relayTestError) : null, relayTestResult === null ? (0, react.createElement)("p", { className: "pbb-diag" }, t(props.t, "push.relayDefault")) : (0, react.createElement)("div", { className: "pbb-helpBody" }, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, relayTestResult.url || t(props.t, "push.relayUrlEmpty")), (0, react.createElement)("code", { className: "pbb-token " + (relayTestResult.overall === "ok" ? "pbb-ok" : "pbb-bad") }, relayTestResult.overall === "ok" ? t(props.t, "push.relayOk") : t(props.t, "push.relayBad"))), relayTestResult.steps.map((step, index) => (0, react.createElement)("p", {
				className: "pbb-diag",
				key: String(index)
			}, (step.ok ? "✓ " : "✗ ") + (step.id === "health" ? t(props.t, "push.relayStep.health") : t(props.t, "push.relayStep.enroll")) + (step.latencyMs !== void 0 ? ` (${String(step.latencyMs)}ms)` : "") + " — " + step.message))), pushTestError ? (0, react.createElement)("p", { className: "pbb-diag pbb-diagBad" }, pushTestError) : null, pushTestResult === null ? (0, react.createElement)("p", { className: "pbb-diag" }, t(props.t, "push.pushDefault")) : (0, react.createElement)("div", { className: "pbb-helpBody" }, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("code", { className: "pbb-token " + (pushTestResult.overall === "sent" ? "pbb-ok" : pushTestResult.overall === "failed" ? "pbb-bad" : "") }, pushTestResult.overall === "sent" ? t(props.t, "push.pushSent") : pushTestResult.overall === "failed" ? t(props.t, "push.pushFailed") : pushTestResult.overall === "no-targets" ? t(props.t, "push.pushNoTargets") : t(props.t, "push.pushNotEnabled"))), pushTestResult.message ? (0, react.createElement)("p", { className: "pbb-diag" }, pushTestResult.message) : null, pushTestResult.results.map((r, index) => (0, react.createElement)("p", {
				className: "pbb-diag",
				key: String(index)
			}, (r.outcome === "sent" ? "✓ " : "✗ ") + r.name + " [" + r.environment + "] — " + r.outcome + (r.reason ? "（" + r.reason + "）" : "") + (r.tokenFingerprint ? "　token:" + r.tokenFingerprint + "…" : "")))))), (0, react.createElement)("div", { className: "pbb-card" }, (0, react.createElement)("div", { className: "pbb-field" }, (0, react.createElement)("div", { className: "pbb-row" }, (0, react.createElement)("span", { className: "pbb-label" }, t(props.t, "devices.title")), (0, react.createElement)("span", { className: "pbb-badge" }, String(report !== null ? report.devices.length : 0))), deviceTable)), report === null ? null : (0, react.createElement)("div", { className: "pbb-versionFooter" }, (0, react.createElement)("span", null, "DeepPilot v" + report.pluginVersion), report.updateAvailable === true ? (0, react.createElement)("a", {
				...
				target: "_blank",
				rel: "noreferrer"
			}, t(props.t, "update.badge")) : null), diag.length > 0 ? (0, react.createElement)("p", { className: "pbb-diag" + (failed ? " pbb-diagBad" : "") }, t(props.t, "diag.prefix") + diag.join(" | ")) : null);
		}
		//#endregion
